...
NIFTY_50 = ['HDFCBANK', 'IOC', 'SHREECEM', 'TATAMOTORS', 'ADANIPORTS',
 'ULTRACEMCO', 'BHARTIARTL', 'HEROMOTOCO', 'HINDUNILVR', 'GRASIM',
 'TATASTEEL', 'UPL', 'AXISBANK', 'HDFC', 'LT', 'POWERGRID', 'SBIN',
 'WIPRO', 'INDUSINDBK', 'INFY', 'ONGC', 'BAJAJFINSV', 'CIPLA', 'KOTAKBANK',
 'MARUTI', 'TCS', 'TITAN', 'BPCL', 'BRITANNIA', 'EICHERMOT', 'ICICIBANK',
 'RELIANCE', 'ASIANPAINT', 'BAJAJ-AUTO', 'NESTLEIND', 'BAJFINANCE', 'COALINDIA',
 'HCLTECH', 'HDFCLIFE', 'HINDALCO', 'DRREDDY', 'GAIL', 'DIVISLAB', 'NTPC', 'TECHM',
 'ITC', 'JSWSTEEL', 'M&M', 'SBILIFE', 'SUNPHARMA']
