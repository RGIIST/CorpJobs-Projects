...
# , 'SBILIFE.NS', 'HDFCLIFE.NS', 'HDFC.NS'
NIFTY_50 = ['HDFCBANK.NS', 'IOC.NS', 'SHREECEM.NS', 'TATAMOTORS.NS', 'ADANIPORTS.NS',
 'ULTRACEMCO.NS', 'BHARTIARTL.NS', 'HEROMOTOCO.NS', 'HINDUNILVR.NS', 'GRASIM.NS',
 'TATASTEEL.NS', 'UPL.NS', 'AXISBANK.NS', 'LT.NS', 'POWERGRID.NS', 'SBIN.NS',
 'WIPRO.NS', 'INDUSINDBK.NS', 'INFY.NS', 'ONGC.NS', 'BAJAJFINSV.NS', 'CIPLA.NS', 'KOTAKBANK.NS',
 'MARUTI.NS', 'TCS.NS', 'TITAN.NS', 'BPCL.NS', 'BRITANNIA.NS', 'EICHERMOT.NS', 'ICICIBANK.NS',
 'RELIANCE.NS', 'ASIANPAINT.NS', 'BAJAJ-AUTO.NS', 'NESTLEIND.NS', 'BAJFINANCE.NS', 'COALINDIA.NS',
 'HCLTECH.NS', 'HINDALCO.NS', 'DRREDDY.NS', 'GAIL.NS', 'DIVISLAB.NS', 'NTPC.NS', 'TECHM.NS',
 'ITC.NS', 'JSWSTEEL.NS', 'M&M.NS', 'SUNPHARMA.NS']
